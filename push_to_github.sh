...
#   GIT_REMOTE_URL - remote repository URL (default: https://github.com/steve-rock-wheelhouser/image-background-remover.git)
#   REMOTE_NAME    - remote name to use (default: origin)
# Example:
#   GIT_REMOTE_URL="git@github.com:steve-rock-wheelhouser/image-background-remover.git" ./push_to_github.sh "Initial commit" main
